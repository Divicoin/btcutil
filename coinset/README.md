...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Divicoin/btcutil/coinset)
...
```bash
$ go get -u github.com/Divicoin/btcutil/coinset
```
